...
const fs = require('fs');
const ownerNumber = ['212639632891']
const prefix = '.'
...
await conn.sendMessage(from , { text: 'error' }, { quoted: mek } )  
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
    ...
    const listMessage = {
      text: " \n\n name : " + q + '\n\n ',
      footer: config.FOOTER,
      title: '🐶WhatsMED🐕 تحميل التطبيقات',
...
╰────────────────────╯
  ...
  // _ _ _ _ _ _ _ _ __  _ _ _ _ _ _  __  _ _ _ __ _  __ _  _ _ _ _ __ _ _  __  __ _  _ __  _ __ _ _ _  _ __ _  _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ __  __ _  __ _ _ _ _   //   		      
		...
		const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + `FN:` + 'MED' + `\n` // full name
            + 'TEL;type=CELL;type=VOICE;waid=' + '212639632891' + ':+' + '212639632891' + '\n' // WhatsApp ID + phone number
            + 'END:VCARD'
 await conn.sendMessage(from,{ contacts: { displayName: 'MED' , contacts: [{ vcard }]  }} , { quoted: mek })      
		      break 
 //_______________________________________________________________________________________________________________________________________________________   //		      
