...
module.exports = {
    ...
    URL_1LINK: process.env.URL_1LINK === undefined ? 'http://instagram.com/wohvwwed' : process.env.URL_1LINK,
    URL_2NAME: process.env.URL_2NAME === undefined ? '✨Star on Github✨' : process.env.URL_2NAME,
    URL_2LINK: process.env.URL_2LINK === undefined ? 'https://github.com/whoisMED' : process.env.URL_2LINK,
    FOOTER: process.env.FOOTER === undefined ? 'WhatsMED  instagram.com/wohvwwed تابعني على الانستغرام ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? '🐶𝙱𝙾𝙱𝙸𝚉 𝙱𝙾𝚃 𝙼𝙳🐕' : process.env.CAPTION,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.ibb.co/VLKcgmL/wm.jpg' : process.env.ALIVE_LOGO,
    ...
    STIC_WM:process.env.STIC_WM === undefined ? 'WhatsMED' : process.env.STIC_WM,
};
